...
const usage = 'usage: spec2flow <validate-onboarding|validate-docs|generate-task-graph|migrate-platform-db|register-platform-project|init-platform-run|lease-next-platform-task|heartbeat-platform-task|start-platform-task|expire-platform-leases|get-platform-run-state|get-platform-observability|serve-platform-control-plane|run-platform-worker-task|run-platform-requirements-worker|run-platform-implementation-worker|run-platform-test-design-worker|run-platform-execution-worker|run-platform-defect-worker|run-platform-collaboration-worker|run-platform-evaluator-worker|init-execution-state|update-execution-state|claim-next-task|submit-task-result|simulate-model-run|preflight-copilot-cli|run-task-with-adapter|run-deterministic-task|run-workflow-loop> --project <file> --topology <file> --risk <file> [--repo-root <dir>] [--repository-id <id>] [--repository-name <name>] [--project-id <id>] [--project-name <name>] [--workspace-root <dir>] [--branch-prefix <prefix>] [--allowed-read-globs <a,b>] [--allowed-write-globs <a,b>] [--forbidden-write-globs <a,b>] [--default-branch <name>] [--database-url <url>] [--database-schema <name>] [--migrations-dir <dir>] [--worker-id <id>] [--lease-ttl-seconds <n>] [--heartbeat-interval-seconds <n>] [--event-limit <n>] [--requirement <text>] [--requirement-file <file>] [--routes <a,b>] [--changed-files <a,b>] [--changed-files-file <file>] [--changed-files-from-git] [--git-diff-repo <path>] [--git-base <ref>] [--git-head <ref>] [--git-staged] [--task-graph <file>] [--state <file>] [--task-id <id>] [--task-status <status>] [--result-status <status>] [--claim <file>] [--adapter-capability <file>] [--adapter-runtime <file>] [--adapter-output <file>] [--preflight-output <file>] [--summary <text>] [--notes <a,b>] [--artifact-refs <a,b>] [--add-artifacts <id|kind|path>] [--add-errors <code|message>] [--executor <name>] [--status <workflow-status>] [--stage <workflow-stage>] [--increment-attempts] [--run-id <id>] [--adapter <name>] [--model <name>] [--session-id <id>] [--max-steps <n>] [--output-base <dir>] [--output <file>] [--host <name>] [--port <n>]';
